 ...
 */
class block_usersprofile extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_usersprofile');
    }
    ...
    function get_content() {
        ...
        $this->content->items[] = '<a title="'.get_string('userlist').'" href="'.
                                  $CFG->wwwroot.'/blocks/usersprofile/index.php?contextid='.$currentcontext->id.'">'.$icon.get_string('usersprofile','block_usersprofile').'</a>';
